...
public class ModItems {
    ...
    public static final DeferredItem<Item> DREAM_WINE = wineItemReg("dream_wine", false, "item.dream_wine.text1", "item.dream_wine.text2", new EffectComponent(List.of(new MobEffectInstance(MobEffects.LUCK, 20 * 300, 5, true, true), new MobEffectInstance(MobEffects.JUMP, 20 * 10, 1000, true, true), new MobEffectInstance(MobEffects.INVISIBILITY, 20 * 300, 1, true, true), new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20 * 300, 5, true, true), new MobEffectInstance(MobEffects.SLOW_FALLING, 20 * 600, 5, true, true))));
    public static final DeferredItem<Item> FROG_WINE = ITEMS.register("frog_wine", registryName -> {ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, registryName);return new FrogWineItem(new Item.Properties().setId(key).component(DataComponents.CONSUMABLE, ModComponents.COMMON_DRINK), false, List.of(Component.translatable("item.frog_wine.text1"), Component.translatable("item.frog_wine.text2")), new EffectComponent(List.of(new MobEffectInstance(MobEffects.UNLUCK, 20 * 600, 5, true, true), new MobEffectInstance(MobEffects.CONFUSION, 20 * 600, 5, true, true), new MobEffectInstance(MobEffects.NIGHT_VISION, 20 * 600, 5, true, true), new MobEffectInstance(MobEffects.JUMP, 20 * 600, 5, true, true), new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 20 * 600, 5, true, true))), new UseRemainderComponent(ModItems.WINE_BOTTLE.get().getDefaultInstance(), 1));});
    ...
    public static final DeferredItem<Item> STORM_WINE = ITEMS.register("storm_wine", registryName -> {ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, registryName);return new StormWineItem(new Item.Properties().setId(key).component(DataComponents.CONSUMABLE, ModComponents.COMMON_DRINK), false, List.of(Component.translatable("item.storm_wine.text1"), Component.translatable("item.storm_wine.text2")), new EffectComponent(List.of(new MobEffectInstance(MobEffects.DARKNESS, 20 * 300, 3, true, true), new MobEffectInstance(MobEffects.SLOW_FALLING, 20 * 300, 1, true, true), new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 20 * 300, 5, true, true), new MobEffectInstance(MobEffects.HEALTH_BOOST, 20 * 300, 5, true, true), new MobEffectInstance(MobEffects.ABSORPTION, 20 * 300, 3, true, true))), new UseRemainderComponent(ModItems.WINE_BOTTLE.get().getDefaultInstance(), 1));});
    public static final DeferredItem<Item> UNLUCK_WINE = wineItemReg("unluck_wine", false,"item.unluck.text1","item.unluck.text2", new EffectComponent(List.of(new MobEffectInstance(MobEffects.UNLUCK,20*300,5,true,true), new MobEffectInstance(MobEffects.BAD_OMEN, 20*300,1,true,true), new MobEffectInstance(MobEffects.POISON,20*300,3,true,true), new MobEffectInstance(MobEffects.DAMAGE_BOOST,20*150,8,true,true), new MobEffectInstance(MobEffects.MOVEMENT_SPEED,20*150,3,true,true))));
