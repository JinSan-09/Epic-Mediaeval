...
public class ModItems {
    ...
    public static final DeferredItem<Item> STORM_WINE = wineItemReg("storm_wine", false, "item.storm_wine.text1", "item.storm_wine.text2", new EffectComponent(List.of(new MobEffectInstance(MobEffects.DARKNESS, 20 * 300, 3, true, true), new MobEffectInstance(MobEffects.SLOW_FALLING, 20 * 300, 1, true, true), new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 20 * 300, 5, true, true), new MobEffectInstance(MobEffects.HEALTH_BOOST,20*300,5,true,true), new MobEffectInstance(MobEffects.ABSORPTION,20*300,3,true,true))));
