...
public class ModMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<StewStoveMenu>> STEW_STOVE_MENU = MENUS.register(
            "stew_stove_menu", () -> new MenuType<>(StewStoveMenu::new,FeatureFlags.DEFAULT_FLAGS));
